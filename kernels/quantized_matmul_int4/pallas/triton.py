...
def quantized_matmul_int4_fwd_kernel(
    ...
    *,
    ...
    o = (
        jnp.outer(x_s, w_s) * o.astype(x_s.dtype)
...
def quantized_matmul_int4_fwd(
    ...
    *,
    ...
    kernel = functools.partial(
        quantized_matmul_int4_fwd_kernel,
        m=m,
        n=n,
        k=k,
        bm=bm,
    ...
    kernel_name = f"quantized_matmul_int4_fwd_{bm}_{bk}_{bn}"
